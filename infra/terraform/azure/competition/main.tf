...
module "scoreboard" {
  source = "../modules/scoreboard_server"
  ...
  scoreboard_port = var.scoreboard_port
}

module "team_env" {
  source = "../modules/team_env"
...
resource "local_file" "hosts_file" {
  content  = yamlencode({"scoreboard": {"hosts": {"ansible_host" : module.scoreboard.scoreboard_ip}},
    "teams": { "hosts": { 
        for team_env in module.team_env: "${team_env.team_id}" => 
